...
test('dismissal and do-not-contact status changes revoke the current invite atomically', () => {
  ...
  assert.match(statusChange, /inviteStatus: currentInviteId \? 'revoked' : 'not_issued'/);
