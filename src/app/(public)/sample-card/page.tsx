...
export const metadata: Metadata = {
  title: 'Experimental Mailer Preflight Concept | CaliforniaMailer',
  description: 'An explanatory, non-final preflight concept for the proposed 24-unit 9 × 12 shared mailer.',
    ...
    <PublicShell>
      <div className="mx-auto max-w-6xl px-5 py-16">
        ...
        <div className="mt-8 max-w-4xl">
          ...
          <h1 className="mt-3 text-4xl font-black md:text-6xl">Preflight the space before selling the boxes.</h1>
