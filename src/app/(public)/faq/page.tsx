...
const faqs = [
  ...
  ['What if the campaign misses its funding goal?', 'CaliforniaMailer cancels under the written campaign funding policy and the owner initiates full refunds of eligible campaign placement payments. The manual review step records the obligation; it does not remove it.'],
