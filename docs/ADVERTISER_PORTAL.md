...
- Existing hashed reservation tokens remain compatible. **Revoke all** increments the reservation access version and clears the legacy token hash, immediately invalidating legacy access and every prior portal session.
